		...
		container: {
 		...
 		extend: {
			...
			animation: {
				...
				'fade-in-50': 'fade-in 0.6s ease-out 0.2s both',
				'slide-in-from-bottom-4': 'slide-in-from-bottom 0.8s ease-out 0.4s both',
				'slide-in-from-bottom-8': 'slide-in-from-bottom 1s ease-out both',
